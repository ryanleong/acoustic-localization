 ...
 * 
 * $Id: RankingPathElementList.java 743 2011-03-12 23:07:14Z perfecthash $
 * 
 * Changes
 * -------
...
final class RankingPathElementList<V, E> extends AbstractPathElementList<V, E, RankingPathElement<V, E>>
{
	 ...
	 * list and <code>np</code> is the maximum number of vertices in the paths stored in the list</li>
	...
	private static class PathMask<V, E> implements MaskFunctor<V, E>
	{
