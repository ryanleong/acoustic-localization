 ...
 * Mikael Hansen
 * 
 * $Id: Graphs.java 725 2010-11-26 01:24:28Z perfecthash $
 * 
 * Changes
 * -------
...
public abstract class Graphs
{
	 ...
	 * specified graph similarly to the {@link Graph#addEdge(Object, Object)} method.
	 * 
	 * @param g the graph for which the specified edge to be added.
	 * @param sourceVertex source vertex of the edge.
	 * @param targetVertex target vertex of the edge.
	 ...
	 * is added to the destination graph. This method returns <code>true</code> if the destination
	 * graph has been modified as a result of this operation,
	 ...
	 * of the graphs is modified while the operation is in progress. {@link #addEdgeWithVertices} is
	 * used for the transfer, so source vertexes will
