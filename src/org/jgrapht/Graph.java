 ...
 * 
 * <p>
 * For guidelines on vertex and edge classes, see <a
 * href="http://pub.eigenbase.org/wiki/JGraphT:EqualsAndHashCode">this wiki page</a>.
 * 
 * @author Barak Naveh
 * @since Jul 14, 2003
 */
public interface Graph<V, E>
{
	 ...
	 * <code>e2.equals(e)</code>. If this graph already contains such
	 ...
	 * specified target vertex, and returns a set of all removed edges. Returns <code>null</code> if
	 * any of the specified vertices does not exist in the
