 ...
 * 
 * @author John Sichi
 * @version $Id: ParanoidGraph.java 645 2008-09-30 19:44:48Z perfecthash $
 */
public class ParanoidGraph<V, E> extends GraphDelegator<V, E>
{
	...
	private static <T> void verifyAdd(Set<T> set, T t)
	{
		for (T o : set)
		{
			...
			{
				throw new IllegalArgumentException ("ParanoidGraph detected objects " + "o1 (hashCode=" + o.hashCode () + ") and o2 (hashCode="
						+ t.hashCode () + ") where o1.equals(o2) " + "but o1.hashCode() != o2.hashCode()");
			}
		}
	}
}
