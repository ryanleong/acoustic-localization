 ...
 * 
 * $Id: MaskEdgeSet.java 645 2008-09-30 19:44:48Z perfecthash $
 * 
 * Changes
 * -------
...
class MaskEdgeSet<V, E> extends AbstractSet<E>
{
	...
	private class MaskEdgeSetNextElementFunctor implements NextElementFunctor<E>
	{
		...
		{
			return MaskEdgeSet.this.mask.isEdgeMasked (edge) || MaskEdgeSet.this.mask.isVertexMasked (MaskEdgeSet.this.graph.getEdgeSource (edge))
