 ...
 * that an edge <tt>(i,j)</tt> implies that <tt>i</tt> appears before <tt>j</tt> in <tt>p</tt>
 * (Skiena 1990, p. 208). See also <a
 ...
 * implementation alternatives. The latter can be found online at <a
 ...
 * cycles, consider using {@link org.jgrapht.alg.CycleDetector} or
